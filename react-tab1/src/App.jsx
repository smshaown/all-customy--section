...
import brandLogo1 from "./assets/image/tabsImages/brand-logo1.webp";
import brandLogo2 from "./assets/image/tabsImages/brand-logo2.webp";
import brandLogo3 from "./assets/image/tabsImages/brand-logo3.webp";
import brandLogo4 from "./assets/image/tabsImages/brand-logo4.webp";
import brandLogo5 from "./assets/image/tabsImages/brand-logo5.webp";
import brandLogo6 from "./assets/image/tabsImages/brand-logo6.webp";
import brandLogo7 from "./assets/image/tabsImages/brand-logo7.webp";
...
function App() {
  ...
  return (
    <>
       <div className="py-[30px] ecom_outer">
      <div className="container">
        ...
        <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 gap-0 lg:gap-10">
          <div className="" data-aos-delay="50"
